        ...
        <section className="flex flex-col md:flex-row h-screen items-center">
          ...
          >
            ...
            <img src={logoimg} alt="" className='w-52 mx-16 block lg:hidden' />
              <h1 className="text-2xl font-bold text-">Welcome <span className='text-blue-800'>Blogiee...</span> </h1>
              ...
              <form className="mt-6" action="#" method="POST">
                <div>
                  ...
                  <input type="email" name="" id="" placeholder="Enter Email Address" className="w-full px-4 py-3 rounded-lg  bg-gray-200 mt-2 border border-black focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus autoComplete="off" required />
                </div>
    
                <div className="mt-4">
                  <label className="block text-gray-700">Password</label>
                  <input type="password" name="" id="" placeholder="Enter Password" minLength="6" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border border-black focus:border-blue-500 focus:bg-white focus:outline-none" required />
                </div>
