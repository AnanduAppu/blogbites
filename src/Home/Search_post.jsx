...
function Search_post() {
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-4">
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 bg-[#dac4dc] p-4 rounded-lg">
            <input
          ...
          <div className="flex flex-col space-y-4">
            <textarea
              className="flex min-h-[80px] w-full border-input bg-background text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 p-4 border rounded-lg"
