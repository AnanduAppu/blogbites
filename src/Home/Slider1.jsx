...
const Slider1 = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg" ref={slideDiv}>
      <section className="relative flex lg:justify-between max-sm:justify-center items-center min-h-[570px] max-sm:min-h-[350px] bg-[radial-gradient(50%_50%_at_50%_50%,#C7F6D0_0%,#7CB686_92.19%)] overflow-hidden z-10">
