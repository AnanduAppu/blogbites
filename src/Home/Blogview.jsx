...
function Blogview() {
  return (
<div className=" max-w-[85rem] py-10 sm:px-6 lg:px-2 lg:py-14 ">
  {/* Grid */}
  <div className=" grid lg:grid-cols-2 gap-5">
    {/* Card */}
    <a className="group sm:flex rounded-xl bg-[#f9f9f5] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 border shadow-lg border-slate-200 hover:border-purple-600 duration-500" href="#">
    ...
    {/* Card */}
    <a className="group sm:flex rounded-xl dark:focus:outline-none bg-[#f7f7f0] dark:focus:ring-1 dark:focus:ring-gray-600 border shadow-lg border-slate-200 hover:border-purple-600 duration-500" href="#">
